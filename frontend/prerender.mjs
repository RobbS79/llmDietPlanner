...
const routes = [
  {
    path: '/',
    outFile: 'index.html',
    title: 'Vařto — Jídelníček s reálnými cenami z obchodu',
    description: 'Zadejte sve cile a Vařto sestavi jidelnicek s recepty a nakupnim seznamem s cenami z Rohliku ci Kauflandu. 2 jidelnicky zdarma, bez karty. Hotovo za 60s.',
    canonical: '/',
  },
  {
    path: '/login',
    ...
    description: 'Prihlaste se ke svemu uctu Vařto a zacnete planovat sve jidelni plany s realnimi cenami z obchodu.',
    canonical: '/login',
  },
  {
    path: '/pricing',
    ...
    title: 'Ceník — Vařto',
    description: 'Vařto je zdarma pro 2 jidelnicky. Placene tarify Standard (99 CZK) a Premium (199 CZK) s vice jidelnicky a akcnimi cenami z obchodu.',
    canonical: '/pricing',
  },
  {
    path: '/o-nas',
    ...
    title: 'O nás — Vařto',
    description: 'Vařto postavil Robert Soroka — planuje zdrava jidla a ukaze, kolik budou stat v obchodech kolem vas. Pribeh zakladatele.',
    canonical: '/o-nas',
  },
  {
    path: '/privacy',
