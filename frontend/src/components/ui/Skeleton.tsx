export const Skeleton = ({ className = '' }: { className?: string }) => (
  <div className={`animate-pulse bg-kraft rounded-xl ${className}`} />
);

export const CardSkeleton = () => (
  <div className="bg-card border border-line rounded-2xl p-8 space-y-6">
...
export const MealCardSkeleton = () => (
  <div className="bg-card border border-line rounded-2xl p-10 space-y-8">
    <div className="flex justify-between">
