    ...
    <main className="max-w-4xl mx-auto px-6 sm:px-12 py-12">
      ...
      <div className="prose prose-invert prose-zinc max-w-none space-y-8 text-sm text-zinc-200 leading-relaxed">
        <section>
          ...
          <p>Správcem vašich osobních údajů je Vařto. V případě dotazů nás kontaktujte na <a href="mailto:admin@kentakin.eu" className="text-emerald-400 hover:text-emerald-300">admin@kentakin.eu</a>.</p>
        </section>
